...
"""
    ...
    if "NASA ADS" in step_title:
        from src.research_tools import ads_search_tool

        print("🔭 Ejecutando NASA ADS directamente...")

        results = ads_search_tool(
            query=prompt,
            max_results=5
        )
        ...
        print("🔭 NASA ADS Output:", content)

        return step_title, "ads_search_tool", content
